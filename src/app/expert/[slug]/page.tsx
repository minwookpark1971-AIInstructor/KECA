    ...
    <>
      ...
      <section className="py-16 lg:py-20">
        <div className="container-custom max-w-3xl text-center">
          ...
          <Link href="/inquiry" className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium bg-accent hover:bg-accent-dark text-white rounded-lg transition-colors">
