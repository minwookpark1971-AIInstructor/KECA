              ...
              >
                <div className="aspect-[16/10] bg-white border border-border flex flex-col items-center justify-center p-6 overflow-hidden">
                  {program.thumbnail_url ? (
                    ...
                    <>
                      <CatIcon size={72} className="text-[#555] mb-3 group-hover:scale-110 transition-transform duration-300" />
                      <span className="text-[#555] text-base font-semibold tracking-wide">{program.category?.name || ""}</span>
                    </>
                  )}
                </div>
                <div className="p-6">
