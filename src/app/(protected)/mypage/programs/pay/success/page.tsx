...
export default function ProgramPaymentSuccessPage() {
  return (
    <>
      <SubpageHero
        title="결제 완료"
      ...
      <section className="py-20">
        <div className="container-custom max-w-lg text-center">
          ...
          <h2 className="text-2xl font-bold text-text mb-2">교육과정 수강료 결제가 완료되었습니다</h2>
          <p className="text-text-sub mb-2">교육 일정은 별도 안내됩니다.</p>
