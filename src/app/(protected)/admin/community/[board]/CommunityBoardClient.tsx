...
import { Plus, Trash2, Pin, Save, X, Edit2 } from "lucide-react";
        ...
        <div className="bg-white border border-primary/20 rounded-xl p-5 mb-4">
          ...
          <div className="space-y-3">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/20 resize-y"
            />
                  ...
                  <td className="px-4 py-3 text-center">
                    <div className="flex items-center justify-center gap-1">
                      <button
                        ...
                        disabled={isPending}
                        className="p-1 text-text-muted hover:text-primary disabled:opacity-50"
                      >
                        <Edit2 size={14} />
                      </button>
                      <button
